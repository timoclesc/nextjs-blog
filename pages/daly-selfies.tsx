...
import styles from 'components/daly-selfies.module.scss';
        ...
        () => {
            const loadImage = image => {
                return new Promise((resolve, reject) => {
                    ...
                    loadImg.src = `/images/daly-selfies-tn/${image}`;
                    ...
                    <> {
                        imageList.map(
                            (image) => (<button key={image} className={styles.button} onClick={() => setSelectedImage(image)}>
                                <img key={image} src={`/images/daly-selfies-tn/${image}`} className={styles.selfieTn} />
                            </button>)
                        )}
                    </>
            }
            {
                selectedImage ?
                    <>
                        ...
                        <img src={`/images/daly-selfies/${selectedImage}`} className={styles.modalImage} onClick={() => setSelectedImage('')} />
                    </>
                    :
                    <></>
            }

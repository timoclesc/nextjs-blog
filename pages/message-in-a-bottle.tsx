...
You look like someone that could benefit from counting their calories. I cannot put into word on this forum how much you mean to me. But we ride together we die together fr fr common Biss W, he just like me fr. Keep gymming with me, maybe I’ll start lifting actual weight one day but probs not until TReN kicks in. Love you as much as I love anabolic steroids.  ~ `,
    ...
    "Timocles Copland": [
        "Thank you for putting this together and for always thinking about (and more importantly, actioning) things that can make the team better, on field and off. It's so exciting to see you reaching the peak of your frisbee powers and I'm so excited for what the year has ahead. You are so special and I'm thankful to call you my partner and teammate. I love you. ~ Max",
        "You're maybe feeling a little burnt out right now, with lots of emotions at every training session, but keep wading through it and remember to enjoy the good bits. The pay off will be worth it. ~ Tim",
        "Friend! Youve been an absolute delight this season, putting in work and crewting a culture of care, support and performance. Im excited to watch you crush it on field, with upcoming AOUGC <3 ~ Rob",
        "Heyy Tim! Thanks for teaching me all the small little tricks you do in frisbee! They really helped me a lot these past few months and I can’t wait to learn more from you this season! ~ Hardie",
        "Tall timbo, You are in my mind the man that puts in all the silent and boring work. The shit that I’d hard to consistently do but you are doing it. Despite already being quite elite I see the effort you put into continually improving and the results are *chef kiss*. Keep being you and I look forward to what the season will bring 🥰 ~ Cam",
        "You have a great layout Ds and strong pressure and skills. ~ Clem",
    ],
    "Tom Tulett": [
